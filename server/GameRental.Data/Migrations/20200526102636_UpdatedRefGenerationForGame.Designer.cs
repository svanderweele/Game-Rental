...
namespace GameRental.Data.Migrations
{
    ...
    [Migration("20200526102636_UpdatedRefGenerationForGame")]
    partial class UpdatedRefGenerationForGame
    {
            ...
            modelBuilder.Entity("GameRental.Core.Models.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 5, 26, 12, 26, 36, 130, DateTimeKind.Local).AddTicks(860),
                            ...
                            PublisherId = 1,
                            Ref = new Guid("2f0e5116-58b8-4076-8083-e99994960164"),
                            ReleaseDate = new DateTime(2007, 11, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdatedAt = new DateTime(2020, 5, 26, 12, 26, 36, 130, DateTimeKind.Local).AddTicks(1300)
                        });
                });
            ...
            modelBuilder.Entity("GameRental.Core.Models.Publisher", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 5, 26, 12, 26, 36, 119, DateTimeKind.Local).AddTicks(3140),
                            Name = "Sony Interactive Entertainment",
                            UpdatedAt = new DateTime(2020, 5, 26, 12, 26, 36, 129, DateTimeKind.Local).AddTicks(7050)
                        });
                });
